...
export default function SearchBar(): React.JSX.Element {
  ...
  const handleSubmit = (): void=> {
    ...
    SearchAPI.getGlobalSearch(query);
  }
  ...
  return (
    <form
      ...
      className="flex items-center justify-center w-full px-5 bg-ui-dark-100 border rounded-[24px] transition-colors outline-2 hover:outline-zinc-300"
    >
      <input
        type="text"
        name="search"
      ...
      <SearchSVG
        ...
        className=" stroke-ui-gray-100 relative left-2.5 cursor-pointer transition hover:stroke-white hover:scale-110 duration-200 ease-in-out"
      />
    </form>
  )
}
